...
const DRAFT = ["create_campaign_draft", "submit_draft", "generate_image", "generate_video", "compose_creative", "analyze_website", "analyze_brand_design", "propose_brand_profile", "attach_media"];

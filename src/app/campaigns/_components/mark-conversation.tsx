...
/**
 * The campaign's two-way conversation with Mark. Operator turns are durable
 * directives queued for Hermes; Mark's turns are the work he produced. Messages
 * persist — Mark works asynchronously and his replies appear here as outputs.
 */

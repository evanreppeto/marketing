      ...
      <div className="overflow-hidden border border-[var(--border-panel)] bg-[var(--surface-panel)] shadow-[var(--elev-panel)]">
        ...
        <div className="border-b border-[var(--border-hairline)] bg-[var(--surface-inset)] px-4 py-3.5">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-[10px] font-semibold text-[var(--accent-contrast)]">
              Featured
            </span>
          ...
          <h2 className="mt-2 font-editorial text-[1.4rem] font-medium leading-tight tracking-[-0.015em] text-[var(--text-primary)]">
            {campaign.name}
          </h2>
          ...
          {locked ? (
            <div className="mt-2.5 flex items-center gap-2 rounded-md border border-[var(--warn-border-soft)] bg-[color-mix(in_srgb,var(--warn-soft)_48%,transparent)] px-2.5 py-1.5">
        ...
        <div className="border-t border-[var(--border-hairline)] px-4 py-3">
          <div className="flex items-center justify-between">
            <h3 className="text-[10px] font-medium text-[var(--text-muted)]">Creative</h3>
        ...
        {/* Performance row */}
        <div className="border-t border-[var(--border-hairline)] px-4 py-3">
          <h3 className="text-[10px] font-medium text-[var(--text-muted)]">Performance</h3>
        ...
        <div className="border-t border-[var(--border-hairline)] bg-[var(--surface-soft)] px-4 py-3.5">
          <div className="flex items-center justify-between">
            <h3 className="text-[10px] font-medium text-[var(--text-muted)]">Launch readiness</h3>
...
function SmsPreview({ body }: { body: string }) {
  return (
    <div className="border border-[var(--border-hairline)] bg-[var(--surface-soft)] p-4">
      ...
      <div className="mt-2.5 max-w-[88%] rounded-md border border-[var(--border-hairline)] bg-[var(--surface-inset)] px-3.5 py-2.5">
    ...
    <div className="space-y-3">
      ...
      <dl className="divide-y divide-[var(--border-hairline)] border border-[var(--border-hairline)] bg-[var(--surface-soft)]">
        ...
        <div className="grid gap-1 px-3 py-2 sm:grid-cols-[5.5rem_minmax(0,1fr)]">
          <dt className="text-[10px] font-medium text-[var(--text-muted)]">Channels</dt>

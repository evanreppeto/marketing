      ...
      <form action={action}>
        ...
        <div className="grid gap-0 xl:grid-cols-[260px_minmax(0,1fr)_320px]">
          ...
          <main className="min-w-0 bg-[var(--surface-soft)] p-4 sm:p-5">
            ...
            >
              <div className="grid gap-1.5">
                <label className="text-sm font-semibold text-[var(--text-primary)]" htmlFor="brand-tone">
                  Tone
                </label>
                <select
...
function FileField({
  ...
  return (
    <label className="grid gap-1.5">
      ...
      <span className={`${theme.surface.dashedEmpty} flex min-h-20 cursor-pointer items-center gap-3 px-3 py-3 text-sm text-[var(--text-secondary)] transition hover:border-[var(--accent-border-strong)] hover:bg-[var(--surface-inset)]`}>
...
function IndustrySelectField({
  ...
  return (
    <div className="grid gap-1.5">
      <label className="text-sm font-semibold text-[var(--text-primary)]" htmlFor="brand-industry">
        Industry
      </label>
      <select
        className={inputClass}
...
function TextAreaField({
  ...
  return (
    <div className="grid gap-1.5">
      ...
      />
      {help ? (
        <span className="text-xs leading-5 text-[var(--text-muted)]" id={helpId}>
          {help}
        </span>
      ) : null}
    </div>

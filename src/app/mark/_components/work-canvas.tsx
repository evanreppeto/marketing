...
import type { MarkActionCard, MarkActionFlag, MarkMedia, MarkMention } from "@/domain";
...
function Artifact({ card, image, onDecision }: { card: MarkActionCard; image?: MarkMedia; onDecision?: (assetId: string, decision: AssetDecision) => void }) {
...
/**
 * The Studio: the persistent right-side workspace for everything Mark generates
 * in a thread. Two tabs — "Now" (what Mark is building / the latest deliverable)

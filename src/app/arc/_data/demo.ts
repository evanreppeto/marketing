    ...
    toolCalls: [
      {
        name: "Find leads",
        status: "complete",
        input: "Flood-zone landlords within a 90-minute response radius, on an active flood watch.",
        output: "3 matches — 2 inbound from the last flood watch, 1 reactivated dormant company. All within the service radius.",
      },
      {
        name: "Score lead",
        status: "complete",
        input: "Rivertown Property Mgmt, scored with the persona-revenue model.",
        output: "Persona: landlord (flood-zone), confidence 0.86. High revenue opportunity. Next best action: offer a priority slot.",
      },
      {
        name: "Weather signal",
        status: "complete",
        input: "Harbor Point — outlook for the next 7 days.",

...
/** Showcases the images/videos Arc attaches to a reply: a responsive gallery
 *  with a smooth fullscreen lightbox for images and inline players for video. */
export function MessageMedia({ media, conversationId, messageId }: { media: ArcMedia[]; conversationId: string; messageId: string }) {

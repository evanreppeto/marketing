...
/** The distinct CRM records Arc referenced across the thread — the live audience. */
export function collectAudienceMentions(messages: ArcMessage[]): ArcMention[] {
 ...
 * for, plus the leads / companies / contacts Arc pulled in, linked to their CRM
 ...
 */
export function AudiencePanel({ messages, assets }: { messages: ArcMessage[]; assets: StudioAsset[] }) {

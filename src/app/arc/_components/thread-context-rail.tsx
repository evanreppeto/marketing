...
import type { ArcActionCard, ArcMention } from "@/domain";
 ...
 *  Arc produced (action cards) and the records referenced along the way.
...
export function ThreadContextRail({
  ...
  const cards: ArcActionCard[] = messages.flatMap((m) => m.actions);
  const seen = new Set<string>();
  const mentions: ArcMention[] = [];

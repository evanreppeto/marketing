...
vi.mock("@/lib/hermes-api", () => ({ appendAgentRunLog: vi.fn() }));

import { appendAgentRunLog } from "@/lib/hermes-api";
...
function logRequest(authorization: string | undefined, body?: unknown) {
  return new Request("http://localhost/api/v1/hermes/tasks/t1/log", {
    method: "POST",
    headers: {
...
describe("POST /api/v1/hermes/tasks/:id/log", () => {

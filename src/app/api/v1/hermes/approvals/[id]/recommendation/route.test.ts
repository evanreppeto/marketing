...
vi.mock("@/lib/hermes-api", () => ({ addApprovalRecommendation: vi.fn() }));

import { addApprovalRecommendation } from "@/lib/hermes-api";
...
function recRequest(authorization: string | undefined, body?: unknown) {
  return new Request("http://localhost/api/v1/hermes/approvals/ap1/recommendation", {
    method: "POST",
    headers: {
...
describe("POST /api/v1/hermes/approvals/:id/recommendation (safety)", () => {

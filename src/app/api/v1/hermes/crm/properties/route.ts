...
/**
 * Read-only property search for Mark — the geo entry point (city / ZIP) for
 * partner and opportunity discovery.
 *
 *   GET /api/v1/hermes/crm/properties?city=Chicago&postal_code=60614&property_type=...&q=&limit=50
 */

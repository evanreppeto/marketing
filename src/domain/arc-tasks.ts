/**
 * Pure normalization for the Arc Operations API task surface.
 *
...
/**
 * The lifecycle actions Arc may take next, given the task's native status.
...
function deriveAssignee(input: NormalizeTaskInput): string {
  if (input.agentKey === "arc") return "arc";

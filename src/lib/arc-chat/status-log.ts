 ...
 *   waking_arc   app is POSTing the wake to the Arc runner (ARC_RUNNER_URL)
 ...
 *
 * The names `waking_arc` / `processing` are observability labels for this chat
 ...
 */
export type ArcChatStatus = "queued" | "waking_arc" | "processing" | "complete" | "failed";
